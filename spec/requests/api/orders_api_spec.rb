...
describe 'Orders API' do
  ...
  context 'POST /api/v1/restaurant/ABC123/orders/ABC12345/canceled' do
    it 'success' do
      allow(SecureRandom).to receive(:alphanumeric).and_return('ABC123')
      admin = Admin.create!(name: 'David', last_name: 'Martinez', cpf: '12223111190', 
      email: 'david@email.com', password: '123456789123')
      ...
      description_params = { description: 'Acabou a cebola' }
      ...
      expect(json_response["description"]).to eq 'Acabou a cebola'
    end
    ...
    it 'fail when order is not awaiting_kitchen_confirmation' do
      ...
      orderable_dishes << OrderableDish.create!(quantity: 1, dish_portion: dish_portion_b)
      allow(SecureRandom).to receive(:alphanumeric).and_return('ABC12345')
      Order.create!(name: 'Julia', email: 'julia@email.com', cpf: '12223111190', orderable_beverages: [orderable_beverage], orderable_dishes: orderable_dishes, restaurant: restaurant, status: :ready)
      description_params = { description: 'Acabou a cebola' }
    ...
    it 'fail when order not found' do
      ...
      post '/api/v1/restaurants/ABC123/orders/11111111/canceled', params: description_params
